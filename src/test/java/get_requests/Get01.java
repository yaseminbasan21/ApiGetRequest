...
import static io.restassured.RestAssured.*;//hepsini birden import edebiliyoruz * ile
...
public class Get01 {
     ...
     */
        ...
        /*
        Given
            https://restful-booker.herokuapp.com/booking/3 //endpoint verilmis
        When
    ...
    public void get01(){
        ...
        // iii)Type code to send request
        Response response=given().when().get(url); //response'umun icine cevabımı koymus oldum,karsıdan bana bi data geldi

       // response.prettyPrint(); //sout yapsak goremeyiz, Response da yazdırmak istiyorsak boyle yaparız
